...
<div id="tbBar" style="padding: 2px 10px;">
	...
	<a class="easyui-linkbutton" plain="true" iconCls="icon-lock" id="setting">设置新密码</a>
	...
	<div class="userSearch">
		<form action="" method="post">
			...
			系统角色：<select class="easyui-combobox" name="position" id="position" panelHeight="auto" editable="false" >   
						<option value=""> </option>
					    <option value="0">管理员</option>   
					    <option value="1">教员</option>   
					    <option value="2">学员</option>   
					</select>
			是否使用：<select class="easyui-combobox" name="isshow" id="isshow" panelHeight="auto" editable="false" >   
						<option value=""> </option>
...
<table id="userTable">   
    <thead>   
        <tr>   
            <th data-options="field:'usernum',width:100">用户账号</th>   
            <th data-options="field:'username',width:100">用户名</th>   
            <th data-options="field:'position_show',width:100">系统角色</th>   
            <th data-options="field:'tel',width:100">联系方式</th>   
            <th data-options="field:'isshow_show',width:100">是否使用</th>   
        </tr>   
    </thead>  
</table>  
